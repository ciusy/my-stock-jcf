...
/**
 * SfzyinvoiceContent entity. @author MyEclipse Persistence Tools
 */

public class SfzyinvoiceContent implements java.io.Serializable {
	...
	/** default constructor */
	public SfzyinvoiceContent() {
	}

	/** minimal constructor */
	public SfzyinvoiceContent(Long id) {
		this.id = id;
	}

	/** full constructor */
	public SfzyinvoiceContent(Long id, Long invoiceNo, String projectName,
