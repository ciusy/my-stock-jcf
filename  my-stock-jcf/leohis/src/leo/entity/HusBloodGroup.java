...
/**
 * HusBloodGroup entity. @author MyEclipse Persistence Tools
 */

public class HusBloodGroup implements java.io.Serializable {
	...
	/** default constructor */
	public HusBloodGroup() {
	}

	/** minimal constructor */
	public HusBloodGroup(String recordId) {
		this.recordId = recordId;
	}

	/** full constructor */
	public HusBloodGroup(String recordId, String abo, String rh, Boolean lis,
