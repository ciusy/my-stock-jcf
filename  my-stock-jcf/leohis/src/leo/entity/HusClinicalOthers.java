...
/**
 * HusClinicalOthers entity. @author MyEclipse Persistence Tools
 */

public class HusClinicalOthers implements java.io.Serializable {
	...
	/** default constructor */
	public HusClinicalOthers() {
	}

	/** minimal constructor */
	public HusClinicalOthers(String recordId) {
		this.recordId = recordId;
	}

	/** full constructor */
	public HusClinicalOthers(String recordId, String other, Boolean lis,
