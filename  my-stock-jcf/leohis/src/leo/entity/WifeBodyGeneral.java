...
/**
 * WifeBodyGeneral entity. @author MyEclipse Persistence Tools
 */

public class WifeBodyGeneral implements java.io.Serializable {
	...
	/** default constructor */
	public WifeBodyGeneral() {
	}

	/** minimal constructor */
	public WifeBodyGeneral(String recordId) {
		this.recordId = recordId;
	}

	/** full constructor */
	public WifeBodyGeneral(String recordId, String height, String weight,
