...
/**
 * WifeClinicalOthers entity. @author MyEclipse Persistence Tools
 */

public class WifeClinicalOthers implements java.io.Serializable {
	...
	/** default constructor */
	public WifeClinicalOthers() {
	}

	/** minimal constructor */
	public WifeClinicalOthers(String recordId) {
		this.recordId = recordId;
	}

	/** full constructor */
	public WifeClinicalOthers(String recordId, String other, Boolean lis,
