...
/**
 * HusSyphilis entity. @author MyEclipse Persistence Tools
 */

public class HusSyphilis implements java.io.Serializable {
	...
	/** minimal constructor */
	public HusSyphilis(String recordId) {
		this.recordId = recordId;
	}

	/** full constructor */
	public HusSyphilis(String recordId, String mdlxtsc, Boolean lis,
