...
/**
 * WifeRoutineUrine entity. @author MyEclipse Persistence Tools
 */

public class WifeRoutineUrine implements java.io.Serializable {
	...
	/** default constructor */
	public WifeRoutineUrine() {
	}

	/** minimal constructor */
	public WifeRoutineUrine(String recordId) {
		this.recordId = recordId;
	}

	/** full constructor */
	public WifeRoutineUrine(String recordId, String results,
