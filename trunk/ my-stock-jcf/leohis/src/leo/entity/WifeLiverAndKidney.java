...
/**
 * WifeLiverAndKidney entity. @author MyEclipse Persistence Tools
 */

public class WifeLiverAndKidney implements java.io.Serializable {
	...
	/** default constructor */
	public WifeLiverAndKidney() {
	}

	/** minimal constructor */
	public WifeLiverAndKidney(String recordId) {
		this.recordId = recordId;
	}

	/** full constructor */
	public WifeLiverAndKidney(String recordId, String alt, String cr,
