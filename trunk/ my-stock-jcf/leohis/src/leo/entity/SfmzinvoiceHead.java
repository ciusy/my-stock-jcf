...
/**
 * SfmzinvoiceHead entity. @author MyEclipse Persistence Tools
 */

public class SfmzinvoiceHead implements java.io.Serializable {
	...
	/** default constructor */
	public SfmzinvoiceHead() {
	}

	/** minimal constructor */
	public SfmzinvoiceHead(Long invoiceNo) {
		this.invoiceNo = invoiceNo;
	}

	/** full constructor */
	public SfmzinvoiceHead(Long invoiceNo, Timestamp invoiceTime,
			...
			Integer medOrgId, Integer uid, Integer costType, String invoiceType) {
		this.invoiceNo = invoiceNo;
