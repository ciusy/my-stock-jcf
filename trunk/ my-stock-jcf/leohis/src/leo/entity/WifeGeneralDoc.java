...
/**
 * WifeGeneralDoc entity. @author MyEclipse Persistence Tools
 */

public class WifeGeneralDoc implements java.io.Serializable {
	...
	/** default constructor */
	public WifeGeneralDoc() {
	}

	/** minimal constructor */
	public WifeGeneralDoc(String recordId) {
		this.recordId = recordId;
	}

	/** full constructor */
	public WifeGeneralDoc(String recordId, String workPressure,
